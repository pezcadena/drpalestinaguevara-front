            ...
            ">
                ...
                <div className="grow flex flex-col gap-gap">
                    ...
                    <div className="flex gap-gap">
                        <article className="flex flex-col gap-gap justify-center bg-white rounded grow">
                            <div className="h-[20rem] w-full bg-primary rounded animate-pulse"></div>
                            <div className="p-padding pt-gap">
                                <div className="h-6 w-[15rem] bg-primary rounded animate-pulse"></div>
                                <div className=" h-4 mt-4 bg-gray-200 rounded w-full animate-pulse"></div>
