                ...
                <div className="grow flex flex-col gap-gap">
                    ...
                    <div className="flex gap-gap flex-wrap">
                        <article className="flex flex-col gap-gap justify-center bg-white rounded grow p-padding">
                            <div className="flex gap-gap items-center flex-wrap">
                                <div className="h-[128px] w-[128px] bg-primary rounded animate-pulse"></div>
                                <div className="flex flex-col gap-mitad-gap">
                                    <div className="h-6 w-[15rem] bg-primary rounded animate-pulse"></div>
                                    <div className="h-4 w-[8rem] bg-primary rounded animate-pulse"></div>
                                </div>
                            </div>
                            <div className="">
